    ...
    function startRecordingAfterMedia(btn, stream) {
        try {
            ...
            if (container) {
                ...
                tb.innerHTML = '<div class="flex items-center bg-[#939BFB] text-white rounded-2xl px-3 py-2 max-w-[70%]"><span class="mr-2">🎙️</span><span class="text-xs">Recording... swipe left to cancel</span></div>';
